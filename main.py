...
def tela_inicio(tela, clock):
    ...
    logo_path = r"images/Torre_Hanoi_Text_Logo.png"
...
# Criando as hastes:
haste1 = Haste(pygame.image.load(r"images/madeira.jpg").convert(), 300, 760)
haste2 = Haste(pygame.image.load(r"images/madeira.jpg").convert(), 700, 760)
haste3 = Haste(pygame.image.load(r"images/madeira.jpg").convert(), 1100, 760)

# Agrupando as hastes em uma tupla:
hastes = (haste1, haste2, haste3)

# Criando as anilhas:
anilha0 = Anilha(0, pygame.image.load(r"images/retanguloAzul.jpg").convert())
anilha1 = Anilha(1, pygame.image.load(r"images/retanguloAzulCiano.jpg").convert())
anilha2 = Anilha(2, pygame.image.load(r"images/retanguloAmarelo.jpg").convert())
anilha3 = Anilha(3, pygame.image.load(r"images/retanguloVermelho.jpg").convert())
anilha4 = Anilha(4, pygame.image.load(r"images/retanguloVerde.jpg").convert())
anilha5 = Anilha(5, pygame.image.load(r"images/retanguloRosa.jpg").convert())
anilha6 = Anilha(6, pygame.image.load(r"images/retanguloRoxo.jpg").convert())
